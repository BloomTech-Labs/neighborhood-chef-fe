...
import EventImageUpload from '../shared/event-image-upload';
...
const ProfileFields = (props) => {
    ...
    useEffect(() => {
        ...
        var registerMapParent = document.getElementsByClassName(
            'register-map'
            ...
            >
                <label
                    className={
                        textBoxStyles({
                            ...
                            addressValue: geoInput.current
                                ? geoInput.current.value
                                : null,
                        }).addressLabel
                    }
                    onClick={moveFocus}
                >
                    <Typography
                        variant={
                            focusAddress ||
                            (geoInput.current && geoInput.current.value)
                                ? 'body2'
                                : 'h6'
                        }
                    >
