        ...
        <div className="createFormPage1RightContainer">
          ...
          <div className="eventTimeDiv">
            ...
            >
              ...
              <MenuItem value={"01:30am"}>1:30am</MenuItem>
              <MenuItem value={"02:00am"}>2:00am</MenuItem>
              <MenuItem value={"02:30am"}>2:30am</MenuItem>
              <MenuItem value={"03:00am"}>3:00am</MenuItem>
              <MenuItem value={"03:30am"}>3:30am</MenuItem>
              <MenuItem value={"04:00am"}>4:00am</MenuItem>
              <MenuItem value={"04:30am"}>4:30am</MenuItem>
              <MenuItem value={"05:00am"}>5:00am</MenuItem>
              <MenuItem value={"05:30am"}>5:30am</MenuItem>
              <MenuItem value={"06:00am"}>6:00am</MenuItem>
              <MenuItem value={"06:30am"}>6:30am</MenuItem>
              <MenuItem value={"07:00am"}>7:00am</MenuItem>
              <MenuItem value={"07:30am"}>7:30am</MenuItem>
              ...
              <MenuItem value={"01:00pm"}>1:00pm</MenuItem>
              <MenuItem value={"01:30pm"}>1:30pm</MenuItem>
              <MenuItem value={"02:00pm"}>2:00pm</MenuItem>
              <MenuItem value={"02:30pm"}>2:30pm</MenuItem>
              <MenuItem value={"03:00pm"}>3:00pm</MenuItem>
              <MenuItem value={"03:30pm"}>3:30pm</MenuItem>
              <MenuItem value={"04:00pm"}>4:00pm</MenuItem>
              <MenuItem value={"04:30pm"}>4:30pm</MenuItem>
              <MenuItem value={"05:00pm"}>5:00pm</MenuItem>
              <MenuItem value={"05:30pm"}>5:30pm</MenuItem>
              <MenuItem value={"06:00pm"}>6:00pm</MenuItem>
              <MenuItem value={"06:30pm"}>6:30pm</MenuItem>
              <MenuItem value={"07:00pm"}>7:00pm</MenuItem>
              <MenuItem value={"07:30pm"}>7:30pm</MenuItem>
              <MenuItem value={"08:00pm"}>8:00pm</MenuItem>
              <MenuItem value={"08:30pm"}>8:30pm</MenuItem>
              <MenuItem value={"09:00pm"}>9:00pm</MenuItem>
              <MenuItem value={"09:30pm"}>9:30pm</MenuItem>
