          ...
          <Card className={`${cardClass.root} ${cardClass.landingPage}`}>
            <CardContent style={{ marginTop: "2%" }}>
              <Typography paragraph>
                Welcome to Neighborhood Chef, a powerful new tool to help you
                engage with your community, make friends, learn new recipes,
                and, most importantly, eat good food. Well, maybe not most
                important. We'll let you decide that. :)
              </Typography>
              <Typography paragraph>
                Built with love as a completely open source project. Learn more
